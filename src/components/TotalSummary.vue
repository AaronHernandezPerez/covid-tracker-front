    ...
    <div v-if="world">
      <q-card-section>
        <div
          ...
          v-text="$options.filters.formatNumberDot(world.cases)"
        ></div>
      ...
      <q-card-section color="primary">
        <div
          ...
          v-text="$options.filters.formatNumberDot(world.deaths)"
        ></div>
      ...
      <q-card-section>
        <div
          ...
          v-text="$options.filters.formatNumberDot(world.critical)"
        ></div>
      ...
      <q-card-section>
        <div
          ...
          v-text="$options.filters.formatNumberDot(world.active)"
        ></div>
      ...
      <q-card-section>
        <div
          ...
          v-text="$options.filters.formatNumberDot(world.recovered)"
        ></div>
        <p class="text-center">{{$t('recovered')}}</p>
      </q-card-section>
    </div>
    <div v-else class="flex items-center justify-center q-pa-lg" style="font-size: 8em">
